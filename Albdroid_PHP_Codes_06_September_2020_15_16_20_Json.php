...
/*
 PHP Code Generated Date: Sunday, 06 September 2020 - 15:16:20
...
$data_array["MP4_Stream"] = $item_data_1;
$data_array["MPD_Stream"] = $item_data_2;
$data_array["Thumbnail"] = $item_data_3;

// Printing Data
// echo json_encode($data_array); // WITH SLASHES
echo str_replace('\/', '/', json_encode($data_array)); // WITHOUT SLASHES
ob_end_flush();
?>